...
public class KoboldChildModel<T extends AbstractKoboldEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leftHorn = head.addOrReplaceChild("left_horn",
				CubeListBuilder.create().texOffs(36, 0).addBox(-0.5F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightHorn = head.addOrReplaceChild("right_horn",
				CubeListBuilder.create().texOffs(45, 0).addBox(-1.5F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -7.0F, 2.0F, -0.6109F, -0.3054F, -0.1745F));
